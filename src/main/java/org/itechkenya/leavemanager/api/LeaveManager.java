 ...
 * new leave events that need to be created automatically. In future, the
 * 10 second polling time will be migrated to a configuration file.
 *
 * @author gitahi
 */
public class LeaveManager implements Runnable {
    ...
    private void autoGenerateLeaveEvents() {
